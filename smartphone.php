...
// recupérer tous les produits de la categorie "Smartphones"
$stmt = $pdo->prepare("SELECT * FROM produits WHERE categorie = :cat");
$stmt->execute(['cat' => 'Smartphones']);
...
<head>
  ...
  <title>Boutique Fixtech — Smartphones</title>
</head>
...
<body>
  <header class="header_boutique">
    ...
    <!--  recherche pour tout les produits (boutique) -->
  ...
  <main class="main_boutique text-center">
    ...
    <section id="liens_boutique">
      <div class="row justify-content-center text-sm-center ">
        <div class="col-12 col-sm-6 col-lg-3 mb-2 mt-2">
          <a class="line_boutique text-bg-light text-primary p-1 rounded-2" href="smartphone.php">Smartphone</a>
        </div>
        <div class="col-12 col-sm-6 col-lg-3 mb-2 mt-2">
    ...
    <section class="présentation_boutique p-4">
      <h1 class="titre_presentation mx-auto">Smartphones</h1>
      <p class="para_presentation mx-auto fw-medium ">
        Découvrez notre sélection de smartphones reconditionnés et garantis : performances, qualité d’écran
        et autonomie au meilleur prix.
      </p>
    </section>
            ...
            <div class="col-auto">
              <div class="card product-card"
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    Produit sélectionné par FixTech.
                  </p>
  ...
  <script src="js/smartphone.js" defer></script>
</body>
