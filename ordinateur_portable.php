...
// جلب كل المنتجات من فئة "Ordinateur"
$sql = "
    SELECT *
    FROM produits
    WHERE categorie LIKE 'Ordinateur%'
    ORDER BY prix ASC
";
...
<head>
  ...
  <!-- Bootstrap Bundle (pour Offcanvas) -->
  ...
  <title>Boutique Fixtech — Ordinateurs portables</title>
</head>
  ...
  <!-- main -->
    ...
    <section id="liens_boutique">
      <div class="row justify-content-center text-sm-center ">
        ...
        <div class="col-12 col-sm-6 col-lg-3 mb-2 mt-2">
          <a class="line_boutique text-bg-light text-primary p-1 rounded-2" href="ordinateur_portable.php">
            Ordinateur portable
          </a>
        </div>
        <div class="col-12 col-sm-6 col-lg-3 mb-2 mt-2">
    ...
    <section class="présentation_boutique p-4">
      <h1 class="titre_presentation mx-auto">Ordinateur portable</h1>
      <p class="para_presentation mx-auto fw-medium">
        Trouvez l’ordinateur portable idéal pour vos besoins personnels ou professionnels. Chez FixTech,
        nous sélectionnons des PC portables neufs et reconditionnés alliant performance, fiabilité et prix
        abordable.
      </p>
    </section>
    <!-- 🔍 FILTRES ORDINATEURS PORTABLES -->
<section class="container my-4" id="ordi-filters">
  <div class="row g-3 justify-content-center">

    <!-- Recherche par nom -->
    <div class="col-md-4">
      <input type="text" id="ordiSearch" class="form-control"
             placeholder="Rechercher un ordinateur...">
    </div>

    <!-- Prix min -->
    <div class="col-md-3">
      <input type="number" id="ordiMinPrice" class="form-control"
             placeholder="Prix min">
    </div>

    <!-- Prix max -->
    <div class="col-md-3">
      <input type="number" id="ordiMaxPrice" class="form-control"
             placeholder="Prix max">
    </div>

    <!-- Bouton reset -->
    <div class="col-md-2">
      <button class="btn btn-outline-primary w-100" id="ordiReset">
        Reset
      </button>
    </div>
